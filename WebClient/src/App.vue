      ...
      <div class="nav-header" @click="onUserAreaClick" style="cursor:pointer;">
        <template v-if="authState.isLoggedIn">
          ...
          <div class="user-info">
            ...
            <div class="user-sub">ChromaDesk</div>
          </div>
        </template>
        <template v-else>
...
function onLangChange(e) {
  ...
  localStorage.setItem('chromadesk_lang', e.target.value)
}
...
async function restoreSession() {
  ...
  if (token) {
    localStorage.setItem('chromadesk_user_token', token)
    updateAuthState()
  }
  ...
  if (r.ok && r.data) {
    ...
    localStorage.setItem('chromadesk_user_info', JSON.stringify({
