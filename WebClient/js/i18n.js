...
const STORAGE_KEY = 'chromadesk_lang';

const zh = {
    // ========== index.html ==========
    'app.title': 'ChromaDesk Web Client',
    'nav.remote': '远程控制',
    'nav.settings': '设置',
    'nav.about': '关于',
    ...
    'about.license': '开源协议',
    'about.licenseDesc': 'ChromaDesk 采用 MIT License 开源协议。其中 chromadesk-remoting 组件基于 Chromium，采用 BSD 3-Clause License 开源协议。',
...
const en = {
    ...
    'about.licenseDesc': 'ChromaDesk is open-sourced under the MIT License. The chromadesk-remoting component is based on Chromium and licensed under the BSD 3-Clause License.',
